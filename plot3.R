## This script will create a plot of submetering against time
...
## plot submetering vs date & time

png("plot3.png", width=480, height=480)
with(powerSubset, plot(DateTimeCombined, Sub_metering_1, type="l", xlab="Day", ylab="Energy sub metering"))
